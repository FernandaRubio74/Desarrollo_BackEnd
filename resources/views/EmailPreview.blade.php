...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Si tienes alguna pregunta o necesitas asistencia, no dudes en contactarnos respondiendo a este correo.
            </p>

            <p>¡Gracias por confiar en nosotros!</p>
        </div>
        <div class="footer">
            <p>&copy; {{$year}} {{$bussines_name}}. Todos los derechos reservados.</p>
            <p><a href="[URL Política de Privacidad]">Política de Privacidad</a> | <a href="[URL Soporte]">Soporte</a>
            </p>
        </div>
    </div>
</body>
