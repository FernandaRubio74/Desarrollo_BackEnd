    ...
    public function __invoke()
    {
        ...
        $data = [
            ...
            'order_status' => match ($request['payment_method']) {
                1 => 'Pendiente de revisado',
                2 => 'En proceso',
                3 => 'En proceso'
            },
            'year' => now()->format('Y'),
            'bussines_name' => 'RubioCorporation',
        ];
        
        $total = 0;
        // Iteramos para cada producto, de esta forma no afecta si se agregan más o se quitan
        foreach ($request['products'] as $product) {
            ...
            $total += $subtotal; // los subtotales se suman para el total
        }
